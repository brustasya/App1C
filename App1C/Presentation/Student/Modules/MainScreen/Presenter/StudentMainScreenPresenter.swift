//
//  StudentMainScreenPresenter.swift
//  App1C
//
...
final class StudentMainScreenPresenter {
    weak var viewInput: StudentMainScreenViewInput?
    weak var moduleOutput: StudentMainScreenModuleOutput?
    ...
    init(
        moduleOutput: StudentMainScreenModuleOutput,
...
extension StudentMainScreenPresenter: StudentMainScreenViewOutput {
    func openTimeTable() {
        moduleOutput?.moduleWantsToOpenTimeTable()
    }
